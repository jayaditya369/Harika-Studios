  ...
  <body>
    ...
    <div class="main-container">
        <div class="options-container">
                ...
                if($y_link)
                {
                    echo " <div class='options' ><a class='active' href='#' style='color: var(--menu-text-color);'><i class='fa-solid fa-video'></i> Home Tour</a></div> ";
                }
                ?>
        </div>
            
        <div class="hometour-realestate" id="b3">
    ...
    <script>
        ...
        {
            location.href="https://www.harikastudios.com/realestate/gallery.php?n="+a+"&p="+b;
        }
    </script>
  </body>
</html>